                ...
                <div class="row">
                    <div class="col-4 fter col-lg-3 mx-2 text-start">
                        ...
                        <div class="col-12 mt-2 text-start ">
                            <span class="text-light text-capitalize fter" style="font-size: 15px;">here we are for helps to you buy and sell products
                        CARTLANKA.COM&trade;
                    make free seller and buyer account sell and buy products
                    </span>
                        </div>
                    </div>
                    <div class="col-4 fter col-lg-3 text-start">
                        <span class="text-light fter text-capitalize" >copyright &copy; 2022-2023 cart lanka inc. All rights reserved
                            <br>
                            
                        Designed by <a href="#" class="text-decoration-none" > AVENTURA SOFTWARE SOLUTIONS&trade;
                        </a>
                        </span>
                    </div>
