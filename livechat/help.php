...
?>
    ...
    <head>
        <title>CARTLANKA || CONTACT ADMINS</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="chat-area">
                            <!-- chatbox -->
                            <div style="display: block;" class="chatbox ">
                                    ...
                                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="d-flex align-items-center">
                                                        <span class="chat-icon"><img class="img-fluid" src="..\resources\logo.png" alt="image title"></span>
                                                        <div class="flex-shrink-0">
                                                            <img class="img-fluid" src="..\resources\logo1.png" style="
                                                        height:40px;
                                                        border-radius:100%;
                                                        " alt="user img">
                                                        </div>
                                        ...
                                        <div class="send-box ">
                                            <div class="btn-group col-12">
                                                <input type="text" id="msgBox" class="form-control" aria-label="message…" placeholder="Write message…">

                                                <button onclick="sendMsg('<?php echo  $_SESSION['ud']['email']; ?>');" type="button"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</button>
