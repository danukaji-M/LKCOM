...
?>
<div id="mailbx" class="d-none"><?php $mailData = "" ?></div>
...
<body>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="Open" role="tabpanel" aria-labelledby="Open-tab">
                                                    ...
                                                    <div class="chat-list">
                                                        ...
                                                        if ($chat !== null) {
                                                            foreach ($chat as $email => $userData) {
                                                                // Access user's email
                                                                $userEmail = $userData['email'];
                                                                $user_data = Database::search("SELECT * FROM `user` WHERE `email`='" . $userEmail . "'")->fetch_assoc();
                                                        ?>
                                                                <a href="#" onclick="showChat('<?php echo $userEmail; ?>');" class="d-flex align-items-center">

                                                                    <div class="flex-shrink-0">
                                                                        <?php
                                                                        $profile_rs = Database::search("SELECT * FROM `profile_img` WHERE `user_email`= '" . $user_data['email'] . "'");
                                                                        $profile_num = $profile_rs->num_rows;
                                                                        if ($profile_num > 0) {
                                                                        ?>
                                                                            <img class="img-fluid" style="height: 40px; width: 40px; border-radius: 50%;" " src=" <?php
                                                                                                                                                                    $profile_data = $profile_rs->fetch_assoc();
                                                                                                                                                                    echo "../" . $profile_data['img_path']
                                                                                                                                                                    ?>" alt="user img">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-3">
                                                                        ...
                                                                        <p style="font-size:10px;"><?php echo $userEmail ?></p>
                                                                    </div>
                                                                </a>
                                                        <?php
                                                            }
                        ...
                        <div class="chatbox ">
                            <div class="modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="msg-body ">
                                            <ul>
                                                ...
                                                if ($chat !== null) {
                                                    // Specify the user's email address you want to display messages for
                                                    $userEmail = $email;

                                                    foreach ($chat as $email => $userData) {
                                                        // Access user's email
                                                        if ($userEmail == $userData['email']) { // Use '==' for comparison
                                    ...
                                    <div class="send-box">
                                        <form action="">
                                            <input type="text" id="adminMsg" class="form-control" aria-label="message…" placeholder="Write message…">
                                            <button onclick="adminRes();" type="button"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</button>
                                        </form>
                                        <div class="send-btns">
                                            <div class="attach">
    ...
    <script src="../livechat/lcscript.js"></script>
